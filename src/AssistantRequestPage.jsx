      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex items-start gap-2 text-sm text-amber-900 bg-amber-50 border border-amber-300 rounded-md p-4">
          ...
          <div className="space-y-2">
            <p>
              助手室への依頼期限は7日以前とします。<br />
              印刷依頼などは、原本を4日前（土日は含みません）までにご提出ください。<br />
              直前になった場合は、ご自身での対応をお願いします。<br />
              講義や授業を実施するために依頼できる仕事量は、一週間で90分程度となっております。<br />
              実験実習のための準備は、90分に含まれません。
            </p>
            <p>
              ※ご依頼内容の具体的な指示は担当者に直接ご連絡ください。（依頼日の翌出勤日に担当者を決める予定です。）
            </p>
            <p>
              ※追記（2024.9.30）<br />
              総合演習Ⅱに関する授業資料の印刷は事務補佐依頼の対象外です。
            </p>
            <p>
              ※月～金曜日、8：40～17：10の出勤時間以外となる依頼は事前にご相談してください
            </p>
          </div>
        </div>
